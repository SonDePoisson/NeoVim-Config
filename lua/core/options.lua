...
-- numéros de ligne
opt.relativenumber = false -- affichage des numéros de ligne relatives à la position actuelle du curseur
...
opt.undofile = false -- on autorise l'undo à l'infini (même quand on revient sur un fichier qu'on avait fermé)
