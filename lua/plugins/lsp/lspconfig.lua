return {
	...
	config = function()
		...
		local lsp_attach = function(_, bufnr)
			...
			vim.keymap.set("n", "<leader>S", vim.lsp.buf.declaration, opts) -- go to declaration

			opts.desc = "Show LSP definitions"
			vim.keymap.set("n", "<leader>s", "<cmd>Telescope lsp_definitions<CR>", opts) -- show lsp definitions
